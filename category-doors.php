...
$description = "Explore our highly secure double-plated steel safety doors, entrance security gates, custom frames, and structural fabrication products manufactured by Khodiyar Steel.";
$page = "products";
include 'header.php';
?>
...
<!-- Subpage Hero Section -->
    <section class="aiero-hero subpage-hero" style="height: 60vh; min-height: 400px; display: flex; align-items: center; justify-content: center; text-align: center;">
        <div class="aiero-slide-content" style="position: relative; margin: 0; padding: 0 4%; max-width: 1000px; text-align: center; align-items: center;">
            ...
            <p class="aiero-slide-desc" style="transform: none; opacity: 1; max-width: 700px; margin: 0 auto;">Luxury entrance safety gates, double-plated fire safety doors, fabricated structural frames, and custom steel grilles.</p>
        </div>
    </section>
    ...
    <section class="aiero-about" style="padding: 6rem 8% 4rem; border-top: 1px solid rgba(255, 255, 255, 0.05);">
        <div class="aiero-about-container" style="grid-template-columns: 1fr 1fr; gap: 5rem;">
            <div class="aiero-about-content">
                ...
                <ul style="list-style: none; display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;">
                    ...
                    <li style="display: flex; gap: 1rem; align-items: flex-start;">
                        ...
                        <span><strong>Main Security Gates & Fabrication</strong>: Bespoke designed decorative structural gates, safety grills, and customized ironwork frames.</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="aiero-about-content" style="justify-content: center; gap: 2rem; background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06); padding: 3rem; border-radius: 20px; text-align: center; align-items: center;">
                ...
                <p style="opacity: 0.6; font-size: 0.92rem; line-height: 1.6; max-width: 320px;">Download our official drafted PDF specification catalog containing door profiles, gate designs, and fabrication tolerances.</p>
    ...
    <section class="aiero-creations" id="products-list" style="border-top: 1px solid rgba(255, 255, 255, 0.05); padding-bottom: 7rem;">
        <div class="aiero-creations-container">
            <div class="aiero-creations-header">
                <span class="aiero-creations-tagline">FABRICATION SELECTIONS</span>
            ...
            <div class="aiero-creations-grid" style="grid-template-columns: repeat(3, 1fr);">
                ...
                <div class="aiero-creation-card-wrapper">
                    <a href="product-details.php?id=safety-door" class="aiero-creation-card card-float-1" style="display: block; height: 380px;">
                ...
                <!-- Card 2 -->
                <div class="aiero-creation-card-wrapper">
                    <a href="product-details.php?id=entrance-gate" class="aiero-creation-card card-float-2" style="display: block; height: 380px;">
                        ...
                        <div class="aiero-creation-content" style="background: none; padding: 2rem;">
                            ...
                            <p class="aiero-creation-desc" style="font-size: 0.85rem; line-height: 1.5;">Bespoke structural entrance security gates with luxury geometric ironwork lines.</p>
                        </div>
                    </a>
                </div>
                ...
                <!-- Card 3 -->
                <div class="aiero-creation-card-wrapper">
                    <a href="product-details.php?id=structural-frame" class="aiero-creation-card card-float-3" style="display: block; height: 380px;">
