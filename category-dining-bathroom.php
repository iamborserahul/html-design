        ...
        <div class="aiero-creations-container">
            ...
            <div class="aiero-creations-grid" style="grid-template-columns: repeat(3, 1fr);">
                ...
                <div class="aiero-creation-card-wrapper">
                    <a href="product-details.php?id=dining-set" class="aiero-creation-card card-float-1" style="display: block; height: 380px;">
                ...
                <!-- Card 2 -->
                <div class="aiero-creation-card-wrapper">
                    <a href="product-details.php?id=vanity-cabinet" class="aiero-creation-card card-float-2" style="display: block; height: 380px;">
                ...
                <!-- Card 3 -->
                <div class="aiero-creation-card-wrapper">
                    <a href="product-details.php?id=mirror-frame" class="aiero-creation-card card-float-3" style="display: block; height: 380px;">
                        <div class="aiero-creation-img" style="background-image: url('assets/project4.jpg');"></div>
                        <div class="aiero-creation-view-more">VIEW DETAILS</div>
                        <div class="aiero-creation-content" style="background: none; padding: 2rem;">
