        ...
        <div class="aiero-about-container" style="grid-template-columns: 1fr 1fr; gap: 5rem;">
            <div class="aiero-about-content">
                ...
                <h3
                    ...
                    Specific Model Outlines:</h3>
                <ul style="list-style: none; display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;">
                    <li style="display: flex; gap: 1rem; align-items: flex-start;">
                        <i class="fa-solid fa-couch" style="color: #FFC229; margin-top: 0.3rem;"></i>
                        <span><strong>Heavy-Duty Bedframes</strong>: Designed with double reinforcement bars to support
                            high load capacity, suited for households, hostels, and hotels.</span>
                    </li>
                    <li style="display: flex; gap: 1rem; align-items: flex-start;">
    ...
    <section class="aiero-creations" id="products-list"
        ...
        <div class="aiero-creations-container">
            <div class="aiero-creations-header">
                ...
                <h2 class="aiero-creations-title" style="font-size: 34px;">Beds & Loungers Models</h2>
            </div>
