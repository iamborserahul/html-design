        ...
        <div class="aiero-creations-container">
            ...
            <div class="aiero-creations-grid" style="grid-template-columns: repeat(3, 1fr);">
                ...
                <div class="aiero-creation-card-wrapper">
                    <a href="product-details.php?id=gazebo" class="aiero-creation-card card-float-1" style="display: block; height: 380px;">
                ...
                <!-- Card 2 -->
                <div class="aiero-creation-card-wrapper">
                    <a href="product-details.php?id=poolside-recliner" class="aiero-creation-card card-float-2" style="display: block; height: 380px;">
                ...
                <!-- Card 3 -->
                <div class="aiero-creation-card-wrapper">
                    <a href="product-details.php?id=outdoor-swing" class="aiero-creation-card card-float-3" style="display: block; height: 380px;">
